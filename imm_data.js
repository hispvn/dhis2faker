...
function personAttirbute(){



  var attributes = [];
  var attribute = {"attribute" : "wbtl3uN0spv", "value" : chance};//Child Number
  attributes.push(attribute);
  var attribute = {"attribute" : "sB1IHYu2xQT", "value" : chance.first()};// First Name
  attributes.push(attribute);
  var attribute = {"attribute" : "OhGYnwya3jg", "value" : chance.last()};// Last Name
  attributes.push(attribute);
  var attribute = {"attribute" : "ptOl3B5Sndx", "value" : gender};// Gender
  attributes.push(attribute);
  var attribute = {"attribute" : "rKtHjgcO2Bn", "value" : dateformat(faker.date.between("2015-01-01","2016-01-01"),"yyyy-mm-dd")};//DOB
  attributes.push(attribute);
  var attribute = {"attribute" : "ftFBu8mHZ4H", "value" : chance.first({gender:"female"})};//Mother First Name
  attributes.push(attribute);
  var attribute = {"attribute" : "EpbquVl5OD6", "value" : chance.last({gender:"female"})};//Mother Last Name
  attributes.push(attribute);
  var attribute = {"attribute" : "pjexi5YaAPa", "value" : chance.phone({formatted: false})};//Phone No
  attributes.push(attribute);
  var attribute = {"attribute" : "QwATZkGIPed", "value" : JSON.stringify(chance.integer({min:1300,max:3900}))};//Birth Weight
  attributes.push(attribute);
  var attribute = {"attribute" : "cGs3k0IhQmQ", "value" : chance.pickone(['Home','Health Facility'])};//Phone No
  attributes.push(attribute);
  var attribute = {"attribute" : "ttjZl7jvrRj", "value" : chance.city()};//Village
  attributes.push(attribute);
  var attribute = {"attribute" : "bsHdoHEjbT9", "value" : chance.address()};//Adress
  attributes.push(attribute);
  var attribute = {"attribute" : "pjexi5YaAPa", "value" : chance.phone({formatted: false})};//Phone No
  attributes.push(attribute);
  var dataValue[];
...
OU4.features.forEach(function(features){
  ...
  var gender=chance.pickone(['Male','Female']);
  var dob=dateformat(faker.date.between("2015-06-01","2016-06-01"),"yyyy-mm-dd");
  var dateRegistration=moment(dob).subtract(chance.integer({min:1,max:5}),'days').format("YYYY-MM-DD");
